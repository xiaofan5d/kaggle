...
if __name__=='__main__':
    ...
    train_data_org = pd.read_csv('D:\\Users\\Administrator\\Desktop\\泰坦尼克船员获救\\titanic_train.csv')
    test_data_org = pd.read_csv('D:\\Users\\Administrator\\Desktop\\泰坦尼克船员获救\\test.csv')
    ...
    submission.to_csv('D:\\Users\\Administrator\\Desktop\\泰坦尼克船员获救\\submission_result.csv',index=False,sep=',')
